...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" href="/cuccutto/assets/images/favicon.png" type="image/x-icon">
    <link rel="icon" href="/cuccutto/assets/images/favicon.ico" type="image/x-icon">

    <!-- Google font-->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">

    <!-- iconfont -->
    <link rel="stylesheet" type="text/css" href="/cuccutto/assets/icon/icofont/css/icofont.css">

    <!-- simple line icon -->
    <link rel="stylesheet" type="text/css" href="/cuccutto/assets/icon/simple-line-icons/css/simple-line-icons.css">
    ...
    <!-- Responsive.css-->
    <link rel="stylesheet" type="text/css" href="/cuccutto/assets/css/responsive.css">
                ...
                <ul class="top-nav">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="bell-notification">
                                ...
                                <span class="media-left media-icon">
                                    <img class="img-circle" src="/cuccutto/assets/images/avatar-1.png" alt="User Image">
                                </span>
                            ...
                            <li class="bell-notification">
                                <a href="javascript:;" class="media">
                                    <span class="media-left media-icon">
                                        <img class="img-circle" src="/cuccutto/assets/images/avatar-2.png" alt="User Image">
                                    </span>
                            ...
                            <li class="bell-notification">
                                <a href="javascript:;" class="media"><span class="media-left media-icon">
                                        <img class="img-circle" src="/cuccutto/assets/images/avatar-3.png" alt="User Image">
                                    </span>
                    ...
                    <li class="dropdown">
                        <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                            <span><img class="img-circle " src="/cuccutto/assets/images/avatar-1.png" style="width:40px;" alt="User Image"></span>
                ...
                <div id="morphsearch" class="morphsearch">
                    ...
                    <div class="morphsearch-content">
                        ...
                        <div class="dummy-column">
                            <h2>Popular</h2>
                            <a class="dummy-media-object" href="#!">
                                <img src="/cuccutto/assets/images/avatar-1.png" alt="PagePreloadingEffect"/>
                                <h3>Page Preloading Effect</h3>
                            </a>

                            <a class="dummy-media-object" href="#!">
                                <img src="/cuccutto/assets/images/avatar-1.png" alt="DraggableDualViewSlideshow"/>
                        ...
                        <div class="dummy-column">
                            <h2>Recent</h2>
                            <a class="dummy-media-object" href="#!">
                                <img src="/cuccutto/assets/images/avatar-1.png" alt="TooltipStylesInspiration"/>
                                <h3>Tooltip Styles Inspiration</h3>
                            </a>
                            <a class="dummy-media-object" href="#!">
                                <img src="/cuccutto/assets/images/avatar-1.png" alt="NotificationStyles"/>
                    ...
                    <div class="main-friend-list">
                        <div class="media friendlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                            ...
                            <a class="media-left" href="#!">
                                <img class="media-object img-circle" src="/cuccutto/assets/images/avatar-1.png" alt="Generic placeholder image">
                        ...
                        <div class="media friendlist-box" data-id="3" data-status="online" data-username="Alice"  data-toggle="tooltip" data-placement="left" title="Alice">
                            <a class="media-left" href="#!">
                                <img class="media-object img-circle" src="/cuccutto/assets/images/avatar-2.png" alt="Generic placeholder image">
                                <div class="live-status bg-success"></div>
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media friendlist-box" data-id="7" data-status="offline" data-username="Michael Scofield" data-toggle="tooltip" data-placement="left" title="Michael Scofield">
                            <a class="media-left" href="#!">
                                <img class="media-object img-circle" src="/cuccutto/assets/images/avatar-3.png" alt="Generic placeholder image">
                        ...
                        <div class="media friendlist-box" data-id="5" data-status="online" data-username="Irina Shayk" data-toggle="tooltip" data-placement="left" title="Irina Shayk">
                            <a class="media-left" href="#!">
                                <img class="media-object img-circle" src="/cuccutto/assets/images/avatar-4.png" alt="Generic placeholder image">
                                <div class="live-status bg-success"></div>
                            </a>
                            <div class="media-body">
                        ...
                        <div class="media friendlist-box" data-id="6" data-status="offline" data-username="Sara Tancredi" data-toggle="tooltip" data-placement="left" title="Sara Tancredi">
                            <a class="media-left" href="#!">
                                <img class="media-object img-circle" src="/cuccutto/assets/images/avatar-5.png" alt="Generic placeholder image">
                                <div class="live-status bg-danger"></div>
                            </a>
                            <div class="media-body">
    ...
    <div class="showChat_inner">
        ...
        <div class="media chat-messages">
            <a class="media-left photo-table" href="#!">
                <img class="media-object img-circle m-t-5" src="/cuccutto/assets/images/avatar-1.png" alt="Generic placeholder image">
                <div class="live-status bg-success"></div>
            </a>
        ...
        <div class="media chat-messages">
            ...
            <div class="media-right photo-table">
                <a href="#!">
                    <img class="media-object img-circle m-t-5" src="/cuccutto/assets/images/avatar-2.png" alt="Generic placeholder image">
                    <div class="live-status bg-success"></div>
                </a>
            </div>
        </div>
        ...
        <ul class="iew-download">
            <li>
                <a href="http://www.google.com/chrome/">
                    <img src="/cuccutto/assets/images/browser/chrome.png" alt="Chrome">
                    <div>Chrome</div>
                </a>
            </li>
            <li>
                <a href="https://www.mozilla.org/en-US/firefox/new/">
                    <img src="/cuccutto/assets/images/browser/firefox.png" alt="Firefox">
                    <div>Firefox</div>
                </a>
            </li>
            <li>
                <a href="http://www.opera.com">
                    <img src="/cuccutto/assets/images/browser/opera.png" alt="Opera">
                    <div>Opera</div>
                </a>
            </li>
            <li>
                <a href="https://www.apple.com/safari/">
                    <img src="/cuccutto/assets/images/browser/safari.png" alt="Safari">
                    <div>Safari</div>
                </a>
            </li>
            <li>
                <a href="http://windows.microsoft.com/en-us/internet-explorer/download-ie">
                    <img src="/cuccutto/assets/images/browser/ie.png" alt="">
                    <div>IE (9 & above)</div>
                </a>
            </li>
        </ul>
...
<!-- Scrollbar JS-->
<script src="/cuccutto/assets/plugins/jquery-slimscroll/jquery.slimscroll.js"></script>
<script src="/cuccutto/assets/plugins/jquery.nicescroll/jquery.nicescroll.min.js"></script>

<!--classic JS-->
<script src="/cuccutto/assets/plugins/classie/classie.js"></script>
